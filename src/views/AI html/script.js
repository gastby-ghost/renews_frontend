...
document.querySelectorAll('.component-stat-item').forEach((item) => {
  item.addEventListener('click', function () {
    ...
    if (component) {
      ...
      document.querySelectorAll('.component-card').forEach((c) => c.classList.remove('active'))
      document
        .querySelector(`.component-card[data-component="${component}"]`)
...
document.querySelectorAll('.filter-tag, .filter-chip').forEach((tag) => {
  tag.addEventListener('click', function () {
    const parent = this.parentNode
    parent
      .querySelectorAll('.filter-tag, .filter-chip')
...
function collectFormData() {
  const formData = {
    ...
    audience: Array.from(document.querySelectorAll('.filter-tag.active')).map(
      (tag) => tag.textContent
    ),
    ...
    keywords: Array.from(document.querySelectorAll('.keyword-tag')).map((tag) =>
...
document.querySelectorAll('.search-mode-selector .mode-tab').forEach((tab) => {
  tab.addEventListener('click', function () {
    document
      .querySelectorAll('.search-mode-selector .mode-tab')
      .forEach((t) => t.classList.remove('active'))
    this.classList.add('active')
    ...
    keywordInput.placeholder =
      currentSearchMode === 'ai' ? '输入关键词，AI将智能理解您的需求...' : '输入关键词进行检索...'
  })
})
    ...
    materials = [
      {
        title: 'AI技术发展报告2023',
        summary:
          '本报告全面分析了2023年人工智能技术的发展现状，包括机器学习、深度学习、自然语言处理等领域的最新进展...',
        type: '报告',
        rating: 5,
        relevance: '高'
      },
      {
        title: '机器学习应用案例集',
        summary:
          '收集了机器学习在各行业的典型应用案例，包括金融、医疗、教育、制造等领域的实际应用...',
        type: '文章',
        rating: 4,
        relevance: '高'
      },
      {
        title: '深度学习最新进展',
        summary:
          '综述了深度学习领域的最新研究进展，包括新型神经网络架构、训练方法优化、应用场景拓展等...',
        type: '文章',
        rating: 4,
        relevance: '高'
      },
      {
        title: 'AI市场规模数据',
        summary:
          '提供了全球人工智能市场的详细数据，包括市场规模、增长率、细分领域占比、区域分布等...',
        type: '数据',
        rating: 4,
        relevance: '中'
      },
...
class TitleGenerator {
  ...
  updateMaterialsList() {
    ...
    materialsList.innerHTML = this.availableMaterials
      .map(
        (material) => `
...
//         title: 'AI技术发展报告2023',
//         type: '报告',
//         summary: '本报告全面分析了2023年人工智能技术的发展现状...'
//       },
//       {
//         id: 'mat_2',
//         title: '机器学习应用案例集',
//         type: '文章',
//         summary: '收集了机器学习在各行业的典型应用案例...'
//       },
//       {
//         id: 'mat_3',
//         title: '深度学习最新进展',
//         type: '文章',
//         summary: '综述了深度学习领域的最新研究进展...'
//       },
//       {
//         id: 'mat_4',
//         title: 'AI市场规模数据',
//         type: '数据',
//         summary: '提供了全球人工智能市场的详细数据...'
//       }
//     ]
//     this.init()
//   }
...
// //     `[data-material-id="${materialManager.currentMaterial.id}"]`
// //   )
// //   if (materialItem) {
